...
// We declared a variable called "number" and assigned it the value 1.
// To increment a variable means we increase the value of the variable by it's exsiting value.
// In this example, we increase the value of the variable number by 1. (number++)
// To check if the value of the variable we incremented is correct, we test it by
// running a conditional statement "if", and console.log 'yes'.
// The conditional statement is true, becasue the value of the variable number is equal to 2, console.log( 'yes' ).
